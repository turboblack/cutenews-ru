...
<?php echo $echo['choose']; ?>

<?php
if (!not_null('users')){
?>

<li><a href="<?php echo $PHP_SELF; ?>?action=users"><?php echo $echo['users']; ?>*</a>
...
<li><a href="<?php echo $PHP_SELF; ?>?action=categories"><?php echo $echo['categories']; ?></a>
...
<li><a href="<?php echo $PHP_SELF; ?>?action=news"><?php echo $echo['news']; ?></a>
...
<li><a href="<?php echo $PHP_SELF; ?>?action=comments"><?php echo $echo['comments']; ?></a>
...
<li><a href="<?php echo $PHP_SELF; ?>?action=xfields"><?php echo $echo['xfields']; ?></a>
...
<li><?php echo $echo['comments']; ?>**
<li><?php echo $echo['xfields']; ?>**

<?php
}
?>

<p>* <?php echo $echo['helpUsers']; ?>
<p>** <?php echo $echo['helpCommentsAndXfields']; ?>