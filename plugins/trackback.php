...
<form name="trackbacks" action="<?php echo $PHP_SELF; ?>?mod=options&amp;action=trackback" method="post">
...
<p>
<input type="submit" value="  <?php echo $echo['add']; ?>  " name="add">
<input type="submit" value="  <?php echo $echo['delete']; ?>  " name="delete">
</p>
</form>
