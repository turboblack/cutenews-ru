...
?>
	<form action="<?php echo $_SERVER["PHP_SELF"]?>" method="get" name="xfieldsform">
	  ...
	  <p>
		...
		<input style="width: 400px;" type="text" name="editedxfield[0]" value="<?php echo htmlspecialchars($editedxfield[0])?>" />
	  <br /><br />
		</b>Description (shown when editing the XField)</b><br />
		<input style="width: 400px;" type="text" name="editedxfield[1]" value="<?php echo htmlspecialchars($editedxfield[1])?>" />
	  <br /><br />
<?php
...
?>
		  ...
		  <select style="width: 400px; border: 0;" name="editedxfield[2]" id="category" onchange="onCategoryChange(this.value)">
			<option value=""<?php echo ($editedxfield[2] == "") ? " selected" : ""?>>All</option>
			<?php echo $cat_options?>
			<option value="custom"<?php echo ($editedxfield[2] != "" and !$cat_selected) ? " selected" : ""?>>Custom...</options>
		  </select>
		<br />
...
?>
		...
		<select style="width: 400px;" name="editedxfield[3]" id="type" onchange="onTypeChange(this.value)" />
		  <option value="text"<?php echo ($editedxfield[3] != "textarea") ? " selected" : ""?>>Single line</option>
		  <option value="textarea"<?php echo ($editedxfield[3] == "textarea") ? " selected" : ""?>>Multi line</option>
		  <option value="select"<?php echo ($editedxfield[3] == "select") ? " selected" : ""?>>Dropdown</option>
		</select>
	  </p>
	  <p id="default_text">
		</b>Default:</b>
		<br />
		<input style="width: 400px;" type="text" name="editedxfield[4_text]" value="<?php echo ($editedxfield[3] == "text") ? htmlspecialchars($editedxfield[4]) : ""?>" />
		<br />
...
?>
		<tr>
		  ...
		  <td <?php echo $rowstyle?>>
			<?php echo (trim($value[2]) ? htmlspecialchars($value[2]) : "All")?>
		  </td>
		  <td <?php echo $rowstyle?>>
			<?php echo (($value[3] == "text") ? "Single line" : "")?>
			<?php echo (($value[3] == "textarea") ? "Multi line" : "")?>
			<?php echo (($value[3] == "select") ? "Dropdown" : "")?>
		  </td>
		  <td <?php echo $rowstyle?>>
			<?php echo ($value[5] != 0 ? "Yes" : "No")?>
		  </td>
		  <td <?php echo $rowstyle?>>
