...
<?php echo $echo['saved']; ?>
<p><a href="javascript:history.go(-1)"><?php echo $echo['back']; ?></a>
...
<p><?php echo $echo['subj']; ?><br /><input type="text" name="title" value="<?php echo replace_news('admin', $tpl->settings['title']); ?>" style="width: 250px;">
<p><?php echo $echo['story']; ?><br /><textarea name="story" rows="15" cols="74"><?php echo replace_news('admin', $tpl->settings['story']); ?></textarea>
<p><input type="submit" name="submit" value=" <?php echo $echo['save']; ?> ">
</form>
