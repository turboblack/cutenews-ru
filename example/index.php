...
<link href="<?php echo $config_http_script_dir; ?>/example/img/style.css" rel="stylesheet" type="text/css" media="screen" />
<link rel="alternate" type="application/rss+xml" title="RSS" href="<?php echo cute_get_link(array(), 'feed', 'rss'); ?>">
<title>
<?php echo cn_title(' &laquo; ', true); ?>
</title>
</head>
...
<table width="600" height="95%" cellspacing="0" cellpadding="0" align="center" bgcolor="#000">
  <tr>
	<td height="95%"> <table width="590" height="100%" align="center" bgcolor="D0CFB4" cellspacing="0" cellpadding="0">
		<tr>
		  <td width="584" height="166" background="<?php echo $config_http_script_dir; ?>/example/img/logo-back.jpg" valign="top">
			<table width="100%" height="88%" cellspacing="0" cellpadding="0">
			  <tr>
				<td width="280" valign="bottom" class="logo" align="center">
				  <?php echo $config_home_title; ?>
				<td width="70">&nbsp;
				<td align="center" valign="bottom" class="calendar">
				  <?php echo cn_calendar(); ?>
			</table>
		  <td rowspan="3" background="<?php echo $config_http_script_dir; ?>/example/img/design.jpg" width="13">&nbsp;
		<tr>
		  <td height="18"> <table width="100%" cellspacing="0" cellpadding="0" class="nav">
			  <tr>
				<td class="nav" style="color: DAD7B8"><img src="<?php echo $config_http_script_dir; ?>/example/img/thread.gif" hspace="5" align="left">
				  <a href="<?php echo $config_http_script_dir; ?>/example">News</a>
				  <!-- Remove index.php/ when using mod_rewrite -->
				  <a href="<?php echo $config_http_script_dir; ?>/example/index.php/category">Categories</a>
				  <a href="<?php echo $config_http_script_dir; ?>/example/index.php/users">Users</a>
				  <a href="<?php echo $config_http_script_dir; ?>/example/index.php/archives">Archives</a>
				  <a href="<?php echo $config_http_script_dir; ?>/example/index.php/search">Search</a>
				<td><img src="<?php echo $config_http_script_dir; ?>/example/img/thread.gif">
			</table>
		<tr>
		  <td valign="top"	background="<?php echo $config_http_script_dir; ?>/example/img/back.jpg">
			<table width="100%" height="122" cellspacing="0" cellpadding="0" background="<?php echo $config_http_script_dir; ?>/example/img/top-page.jpg">
			  <tr>
				<td class="name"><?php echo ($header[$do] ? $header[$do] : 'News'); ?>
			</table>
...
?>
			...
			<table width="100%" height="194" cellspacing="0" cellpadding="0" background="<?php echo $config_http_script_dir; ?>/example/img/back-support.jpg">
			  <tr>
	...
	<td><br /> <table class="rights" width="95%"  align="center"cellspacing="0" cellpadding="0">
		<tr>
		  <td valign="top">Powered by <a href="http://cutenews.ru" style="color: F2EFCB"><b>GoodGirl</b></a>
			&copy; 2004-
			<?php echo date('Y'); ?>
			. <a href="<?php echo cute_get_link(array(), 'feed', 'rss'); ?>" style="color: F2EFCB"><strong>RSS</strong></a>
		  <td align="right">
			<?php
			...
			if (!global_cache){
			?>
			Generated in <?php echo $pgt->stop(); ?> seconds. <br />
			DB queries: <?php echo $sql->query_count(); ?><br />
			<?php } ?>
			<br /> <br /> </table>
</table>
</body>
