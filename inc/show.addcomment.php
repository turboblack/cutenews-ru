...
<div class="error_message"><?php echo $echo['nameLong']; ?></div>
...
<div class="error_message"><?php echo $echo['mailLong']; ?></div>
...
<div class="error_message"><?php echo $echo['commentLong']; ?></div>
...
<div class="error_message"><?php echo sprintf($echo['flood'], $config_flood_time); ?></div>
...
<div class="error_message"><?php echo $echo['sorryYouSuck']; ?></div>
...
<form method="post" action=""><?php echo $echo['password']; ?>
...
<input type="hidden" name="ucat" value="<?php echo $ucat; ?>">
<input type="hidden" name="rememberme" value="<?php echo $rememberme; ?>">
<?php echo cute_query_string($QUERY_STRING, array('category', 'skip', 'subaction', 'id', 'ucat'), 'post'); ?>
...
<div class="error_message"><?php echo $echo['onlyUsers']; ?></div>
...
<div class="error_message"><?php echo $echo['nameEmpty']; ?></div>
...
<div class="error_message"><?php echo $echo['mailEmpty']; ?></div>
...
<div class="error_message"><?php echo $echo['mailWrong']; ?></div>
...
<div class="error_message"><?php echo $echo['commentEmpty']; ?></div>
...
setCookie("commentname", "<?php echo urlencode($name); ?>", now);
...
setCookie("commentmail", "<?php echo $mail; ?>", now);
...
<script type="text/javascript">self.location.href="<?php echo $_SERVER['HTTP_REFERER']; ?>";</script>
