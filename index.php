...
<!-- Javascript redirect -->
<script type="text/javascript">self.location.href="<?php echo $_SERVER['PHP_SELF']; ?>";</script>
...
<table border="0" cellspacing="0" cellpadding="1">
 <form name="login" action="<?php echo $PHP_SELF; ?>" method="post" onsubmit="return process_form(this)">
  <tr>
   <td width="80"><?php echo $echo['username']; ?>
   <td><input tabindex="1" type="text" name="username" value="<?php echo $lastusername; ?>" style="width:134">
  <tr>
   <td><?php echo $echo['password']; ?>
   <td><input type="password" name="password" style="width:134">
  <tr>
   <td>
   <td><input accesskey="s" type="submit" style="width:134;" value="<?php echo $echo['login']; ?>">
  <tr>
   <td align="center" colspan="3"><?php echo $result; ?></td>
  </tr>
...
<?php
   echofooter();
	...
	if (check_referer){
		...
		if (!preg_match("/$self/i", $HTTP_REFERER) and $HTTP_REFERER){
...
<!-- Страница сгенерирована за <?php echo $timer->stop(); ?> сек. -->